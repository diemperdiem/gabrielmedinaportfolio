...
const textEng = ['Software Engineer', 'Fullstack Developer', 'Musician', 'Designer'];
const textEsp = ['Software Engineer', 'Fullstack Developer', 'Musico', 'Diseñador'];
const exampleTyping = new AutoTyping('#text', textEng , {
    typeSpeed: 100,
    deleteSpeed: 100,
